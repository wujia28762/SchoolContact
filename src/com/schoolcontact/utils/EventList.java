...
public class EventList {
	...
	/**
	 * @description 请求DATA（用于HTTP请求,DATA 参数）
	 */
	...
	/**
	 * @description 请求动作（用于HTTP请求,ACTOR 参数）
	 */
	...
	/**
	 * @description 事件标识（用于HTTP请求,EVENT 参数）
	 */
