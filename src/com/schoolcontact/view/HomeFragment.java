...
//										Toast.makeText(instance, "断开连接！", Toast.LENGTH_LONG).show();
//										break;
//									case CONNECTING:// 连接中。
//										Toast.makeText(instance, "连接中！", Toast.LENGTH_LONG).show();
//										break;
...
//										Toast.makeText(instance, "其它登录", Toast.LENGTH_LONG).show();
